...
const servicePriceDefs = [
  ...
  { key:"services.consultation.fee_egp", label:"إجمالي الاستشارة", description:"المبلغ الكامل المطلوب لحجز الاستشارة؛ لا يوجد متبقٍ منفصل في هذا المسار.", icon:MessageSquareText },
