...
final class SettingsController extends Controller
{
    ...
    private function validateValue(string $key,mixed $value): mixed
    {
        return match($key){
            ...
            'services.contract_review.fee_egp','services.contract_review.deposit_egp','services.consultation.fee_egp','services.contract_drafting.deposit_egp'=>$this->number($value,0,100000),
