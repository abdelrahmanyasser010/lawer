...
final class CatalogController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $keys = [
            ...
            'services.contract_review.fee_egp','services.contract_review.deposit_egp','services.consultation.fee_egp','services.contract_drafting.deposit_egp',
            'office.display_name','office.address','office.support_email','office.whatsapp_number','office.consultation_whatsapp_number','office.support_whatsapp_number','office.support_phone',
        ];
        ...
        $consultationFee = (float) $get('services.consultation.fee_egp',0);
        ...
        return $this->ok($request, [
            ...
            'services' => [
                ...
                'consultationDepositEgp' => $consultationFee,
                'consultationFeeEgp' => $consultationFee,
