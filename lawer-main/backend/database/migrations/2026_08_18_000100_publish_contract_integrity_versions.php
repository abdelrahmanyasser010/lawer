    ...
    public function up(): void
    {
        $specifications = [
            [
                ...
                'file' => 'rental.json',
                'version' => 9,
                'summary' => 'تنظيف النصوص القانونية، توحيد المحكمة المختارة، وتحسين سلامة العرض والملاحق في عقود الإيجار.',
            ],
            [
                'slug' => 'apartment_sale',
                'file' => 'apartment_sale.json',
                'version' => 8,
                'summary' => 'تنظيف النصوص القانونية، توحيد المحكمة المختارة، وتحسين سلامة العرض والملاحق في عقود البيع.',
            ],
            [
                'slug' => 'freelancer',
                'file' => 'freelancer.json',
                'version' => 7,
                'summary' => 'إلزام اختيار المحكمة المختصة وتوحيد قائمتها وتنظيف نصوص عقود الخدمات والعمل الحر وملاحقها.',
            ],
        ];
        ...
        DB::transaction(function () use ($publications): void {
            foreach ($publications as $publication) {
                ...
                if ($version) {
                    ...
                    $incoming = json_decode($publication['raw'], true, 512, JSON_THROW_ON_ERROR);
                    ...
                    $versionId = DB::table('template_versions')->insertGetId([
                        ...
                        'legal_reference' => 'Contract integrity and protected preview review approved 2026-08-18',
                        'effective_from' => now(),
                        'published_at' => now(),
                        'created_at' => now(),
                        'updated_at' => now(),
