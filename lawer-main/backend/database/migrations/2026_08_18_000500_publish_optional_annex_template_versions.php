    ...
    public function up(): void
    {
        $specifications = [
            [
                ...
                'file' => 'rental.json',
                'version' => 12,
                'summary' => 'إلغاء أي إلزام أو إضافة تلقائية لمحضر الاستلام والجرد؛ جميع الملاحق يختارها المستخدم فقط.',
            ],
            [
                'slug' => 'apartment_sale',
                'file' => 'apartment_sale.json',
                'version' => 11,
                'summary' => 'جعل ملحق جدول الأقساط اختياريًا بالكامل وعدم إضافته تلقائيًا عند البيع بالتقسيط.',
            ],
            [
                'slug' => 'freelancer',
                'file' => 'freelancer.json',
                'version' => 10,
                'summary' => 'جعل جميع ملاحق عقود العمل الحر اختيارية بالكامل وعدم إضافة أي ملحق تلقائيًا.',
            ],
        ];
            ...
            foreach ($publications as $publication) {
                ...
                if ($version) {
                    ...
                    $versionId = DB::table('template_versions')->insertGetId([
                        ...
                        'legal_reference' => 'All annexes are optional and user-selected; approved 2026-08-18',
                        'effective_from' => now(),
                        'published_at' => now(),
                        'created_at' => now(),
                        'updated_at' => now(),
