...
} from "../../legal-content/freelanceSourceClauses.ts";
import { competentCourtOptions, contractDateField } from "../common.ts";
...
const optionalClauses: OptionalClauseDefinition[] = [
  optionalClause({ key: "visual_identity_scope_annex", nameAr: "ملحق نطاق العمل والمخرجات الفنية", description: "تُنقل إليه بيانات العقد المشتركة، وتُستكمل تفاصيل الخدمات والمخرجات والمراجعات وجدول التنفيذ قبل اعتماده.", title: "ملحق نطاق العمل والمخرجات الفنية", source: "ملحق رقم (1).pdf", variant: "visual_identity_design", steps: visualScopeSteps }),
  optionalClause({ key: "visual_identity_financial_annex", nameAr: "ملحق المقابل المالي وخطة التنفيذ", description: "تُنقل إليه بيانات العقد المشتركة، وتُستكمل تفاصيل القيمة والدفعات ووسائل السداد وشروط بدء التنفيذ قبل اعتماده.", title: "ملحق المقابل المالي وآلية السداد وخطة التنفيذ", source: "ملحق المقابل المالي وآلية السداد وخطة التنفيذ.pdf", variant: "visual_identity_design", steps: visualFinancialSteps }),
  optionalClause({ key: "visual_identity_approvals_annex", nameAr: "ملحق الاعتمادات وإدارة التنفيذ", description: "تُنقل إليه بيانات العقد المشتركة، ويُستكمل سجل المراحل والمراجعات والتعديلات والتسليم قبل اعتماده.", title: "ملحق الاعتمادات وإدارة التنفيذ", source: "الملحق رقم (3).pdf", variant: "visual_identity_design", steps: visualApprovalsSteps }),
