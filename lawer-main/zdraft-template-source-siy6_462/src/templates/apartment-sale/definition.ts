...
const installmentAnnex: OptionalClauseDefinition = {
  ...
  description: "ملحق قابل للطباعة يُضاف تلقائيًا عند اختيار البيع بالتقسيط؛ تُنقل إليه بيانات العقد المشتركة وتُستكمل تفاصيل الأقساط قبل الاعتماد.",
...
export const apartmentSaleTemplateDefinition: ContractTemplateDefinition = {
  ...
  description: "ثلاثة عقود بيع مستقلة مطابقة للنماذج: بيع ابتدائي، بيع قابل للتسجيل بالشهر العقاري، وبيع لوحدة آلت بالميراث، مع ملحق أقساط قابل للطباعة وتعبئة البيانات المشتركة تلقائيًا.",
  priceEgp: 0,
  variantPricing: {
