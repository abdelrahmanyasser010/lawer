...
import { rentalSourceClauseKeysByVariant, rentalSourceLegalClauses } from "../../legal-content/sourceClauses.ts";
...
const handoverOptionalClause: OptionalClauseDefinition = {
  ...
  description: "محضر قابل للطباعة تُنقل إليه بيانات العقد المشتركة، وتُستكمل فيه حالة العين ووسائل الدخول والمنقولات عند التسليم. يصبح إلزاميًا تلقائيًا إذا كانت العين السكنية مفروشة أو كان تسليم العين الإدارية وفق محضر الجرد.",
  ...
  insertedSteps: [
    {
      ...
      articleRange: "محضر مستقل — بيانات مشتركة تلقائية وتفاصيل للاستكمال",
      fields: [
...
export const rentalTemplateDefinition: ContractTemplateDefinition = {
  ...
  description: "ثلاثة عقود إيجار مستقلة مطابقة للنماذج السكنية والتجارية والإدارية، مع محضر استلام وجرد قابل للطباعة وتعبئة البيانات المشتركة تلقائيًا.",
  priceEgp: 0,
  variantPricing: {
