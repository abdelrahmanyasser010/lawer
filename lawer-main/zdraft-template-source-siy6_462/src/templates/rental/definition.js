...
exports.rentalTemplateDefinition = void 0;
...
const rentalPartyFields = (prefix, partyLabel) => [
    { key: `${prefix}_party_type`, type: "radio", labelAr: `صفة ${partyLabel}`, required: true, options: partyTypeOptions },
    { key: `${prefix}_name`, type: "text", labelAr: `الاسم الكامل لـ${partyLabel}`, required: true, validation: { minLength: 3 } },
    ...
    { key: `${prefix}_id_issuer`, type: "text", labelAr: "جهة إصدار الهوية" },
    { key: `${prefix}_id_issue_date`, type: "date", labelAr: "تاريخ إصدار الهوية" },
    ...
    { key: `${prefix}_company_name`, type: "text", labelAr: "اسم الشركة / المنشأة", required: true, visibleWhen: { fieldKey: `${prefix}_party_type`, operator: "equals", value: "company" } },
    ...
    { key: `${prefix}_commercial_register`, type: "text", labelAr: "رقم السجل التجاري", required: true, visibleWhen: { fieldKey: `${prefix}_party_type`, operator: "equals", value: "company" } },
    { key: `${prefix}_tax_card`, type: "text", labelAr: "رقم البطاقة الضريبية", required: true, visibleWhen: { fieldKey: `${prefix}_party_type`, operator: "equals", value: "company" } },
    ...
    { key: `${prefix}_representative_capacity`, type: "text", labelAr: "صفة الممثل القانوني", required: true, visibleWhen: { fieldKey: `${prefix}_party_type`, operator: "equals", value: "company" } },
    ...
    { key: `${prefix}_id_card_front`, type: "attachment", labelAr: `وجه بطاقة ${partyLabel}`, required: true },
    { key: `${prefix}_id_card_back`, type: "attachment", labelAr: `ظهر بطاقة ${partyLabel}`, required: true },
];
const rentalCommonSteps = [
...
const administrativeVariantStep = {
...
exports.rentalTemplateDefinition = {
    slug: "rental",
    version: 4,
    ...
    variants: [
        createRentalVariant({
            ...
            requiredClauseKeys: [...sourceClauses_1.rentalSourceClauseKeysByVariant.residential_lease],
            defaults: {
                rooms_count: "3",
                bathrooms_count: "1",
                balconies_count: "1",
        ...
        createRentalVariant({
            ...
            requiredClauseKeys: [...sourceClauses_1.rentalSourceClauseKeysByVariant.commercial_lease],
            defaults: {
                property_area: "80",
        ...
        createRentalVariant({
            ...
            requiredClauseKeys: [...sourceClauses_1.rentalSourceClauseKeysByVariant.administrative_lease],
            defaults: {
                property_area: "100",
    ...
    optionalClauses: [
        {
            ...
            legalClauseKeys: [...sourceClauses_1.rentalSourceClauseKeysByVariant.rental_handover_inventory_report],
            defaultFieldValues: {
            ...
            insertedSteps: [
                {
                    ...
                    sourceClauseKey: sourceClauses_1.rentalSourceClauseKeysByVariant.rental_handover_inventory_report[0],
    ...
    legalClauses: sourceClauses_1.rentalSourceLegalClauses,
};
