...
const handoverOptionalClause: OptionalClauseDefinition = {
  ...
  description: "قالب فارغ للطباعة والتعبئة اليدوية فقط؛ لا تُنقل إليه بيانات الـWizard. يصبح إلزاميًا تلقائيًا إذا كانت العين السكنية مفروشة أو كان تسليم العين الإدارية وفق محضر الجرد.",
...
export const rentalTemplateDefinition: ContractTemplateDefinition = {
  ...
  description: "ثلاثة عقود إيجار مستقلة مطابقة للنماذج السكنية والتجارية والإدارية، مع محضر استلام وجرد فارغ قابل للطباعة والتعبئة اليدوية.",
  priceEgp: 0,
  variantPricing: {
