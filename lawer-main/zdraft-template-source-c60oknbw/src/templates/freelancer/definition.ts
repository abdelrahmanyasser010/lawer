...
function optionalClause(input: {
  ...
  return {
    key: input.key,
    nameAr: input.nameAr,
    description: `قالب فارغ للطباعة والتعبئة اليدوية؛ لا تُنقل إليه بيانات الـWizard. ${input.description}`,
...
export const freelancerTemplateDefinition: ContractTemplateDefinition = {
  ...
  description: "عقود الهوية البصرية وتطوير المواقع وإدارة منصات التواصل مع ملاحق مستقلة فارغة قابلة للطباعة والتعبئة اليدوية.",
  priceEgp: 0,
  variantPricing: {
