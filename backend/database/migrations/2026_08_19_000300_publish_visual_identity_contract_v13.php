...
return new class extends Migration {
    public function up(): void
    {
        ...
        if ($canonicalVersion !== $targetVersion) {
            throw new RuntimeException('Canonical freelancer v13 definition is required by this migration.');
        }
        ...
        DB::transaction(function () use ($raw, $definition, $targetVersion): void {
            ...
            if ($version) {
                ...
                if ($existing != $definition) {
                    throw new RuntimeException('freelancer template version 13 already exists with a different immutable definition.');
                }
                ...
                $versionId = DB::table('template_versions')->insertGetId([
                    ...
                    'status' => 'published',
                    'definition_json' => $raw,
                    'change_summary' => 'مراجعة شاملة لعقد تصميم الهوية البصرية: ربط بيانات الأطراف والهوية والمشروع ونطاق الخدمات والمخرجات والملفات المصدرية والمدة والسداد والمراجعات والملكية الفكرية وPortfolio ومدد الإنهاء والإخطارات والمحكمة داخل المواد القانونية، مع فحص تغطية Fail-Closed لكل حقول الـWizard.',
                    'legal_reference' => 'Reviewed against عقد الهوية البصرية(1).pdf (11 pages), approved 2026-08-19',
                    'effective_from' => now(),
                    'published_at' => now(),
                    'created_at' => now(),
                    'updated_at' => now(),
