    ...
    public function up(): void
    {
        $specifications = [
            [
                ...
                'file' => 'rental.json',
                'version' => 11,
                'summary' => 'إصدار محضر الاستلام والجرد كقالب فارغ للطباعة والتعبئة اليدوية دون نقل بيانات الـWizard.',
            ],
            [
                'slug' => 'apartment_sale',
                'file' => 'apartment_sale.json',
                'version' => 10,
                'summary' => 'إصدار ملحق جدول الأقساط كقالب فارغ للطباعة والتعبئة اليدوية دون نقل بيانات الـWizard.',
            ],
            [
                'slug' => 'freelancer',
                'file' => 'freelancer.json',
                'version' => 9,
                'summary' => 'إصدار ملاحق عقود العمل الحر كقوالب فارغة للطباعة والتعبئة اليدوية دون نقل بيانات الـWizard.',
            ],
        ];
            ...
            foreach ($publications as $publication) {
                ...
                if ($version) {
                    ...
                    $versionId = DB::table('template_versions')->insertGetId([
                        ...
                        'legal_reference' => 'Blank printable annex behavior approved 2026-08-18',
                        'effective_from' => now(),
                        'published_at' => now(),
                        'created_at' => now(),
                        'updated_at' => now(),
