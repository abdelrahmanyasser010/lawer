    ...
    public function up(): void
    {
        $specifications = [
            [
                ...
                'version' => 11,
                'summary' => 'ربط القيم القانونية الأساسية داخل مواد العقود، وإضافة اختيار صريح بين الرقم القومي وجواز السفر، وإزالة خطوة البنود الاختيارية العامة.',
            ],
            [
                'slug' => 'rental',
                'file' => 'rental.json',
                'version' => 13,
                'summary' => 'ربط وصف العين والتسليم والمدة والأجرة والتأمين وعدد النسخ والتفاصيل الإضافية مباشرة داخل المواد القانونية، مع اختيار صريح لمستند الهوية.',
            ],
            [
                'slug' => 'apartment_sale',
                'file' => 'apartment_sale.json',
                'version' => 12,
                'summary' => 'ربط وصف الوحدة والعدادات والثمن وسند الملكية والضريبة والبيانات القانونية الأساسية مباشرة داخل مواد عقود البيع، مع اختيار صريح لمستند الهوية.',
            ],
        ];
            ...
            foreach ($publications as $publication) {
                ...
                if ($version) {
                    ...
                    $versionId = DB::table('template_versions')->insertGetId([
                        ...
                        'legal_reference' => 'Wizard-to-legal-text binding and identity-document selection review approved 2026-08-19',
                        'effective_from' => now(),
                        'published_at' => now(),
                        'created_at' => now(),
                        'updated_at' => now(),
