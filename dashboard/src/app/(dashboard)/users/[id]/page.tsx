...
const requestTypeLabels:Record<string,string>={contract_drafting:"إعداد عقد بواسطة محامي المكتب",contract_review:"مراجعة عقد أو مستند"};
