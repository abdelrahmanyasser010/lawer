...
const sections = [
  ...
  {
    icon: Scale,
    title: "الفرق بين إنشاء العقد ومراجعة عقد قائم",
    items: [
      "العقد الذاتي يُنشأ من إجاباتك على القالب، ولا يتضمن تلقائيًا مراجعة قانونية مخصصة لعقد قائم أو لحالة بعينها.",
      "مراجعة العقد القائم خدمة مستقلة عن الإنشاء الذاتي؛ ترفع العقد المراد مراجعته ويحدد المكتب نطاق العمل وموعد مناقشة التقرير.",
      "مناقشة تقرير المراجعة تتم عبر Zoom أو WhatsApp بحسب القنوات المتاحة؛ لا توجد محادثات داخل المنصة.",
    ],
  },
  {
    icon: ShieldCheck,
    ...
    items: [
      ...
      "عند إرفاق عقد أو مستند ضمن طلب المراجعة، يحتفظ النظام بالمرفقات وأي ملفات أو نتائج يتيحها المكتب ضمن سجل الطلب.",
    ],
  },
];
