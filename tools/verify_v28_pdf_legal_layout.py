...
checks={
 ...
 'rtl_numbering_isolated_live_preview': '[unicode-bidi:isolate]' in preview and '<bdi dir="ltr"' in preview and 'flex items-start gap-1' in preview,
 'rtl_numbering_isolated_pdf': '.clause-number { direction:ltr; unicode-bidi:isolate;' in blade and '<span class="clause-number" dir="ltr">' in blade,
}
