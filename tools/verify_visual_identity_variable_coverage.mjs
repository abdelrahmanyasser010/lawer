...
const audit = auditVariantFieldCoverage(freelancerTemplateDefinition, 'visual_identity_design', {
...
const markdown = `# خريطة ربط متغيرات عقد الهوية البصرية — v13\n\n` +
...
const out = path.resolve('docs/VISUAL_IDENTITY_VARIABLE_COVERAGE_V13_AR.md');
