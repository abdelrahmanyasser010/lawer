...
| `website_total_price` | إجمالي المقابل المالي (جنيه مصري) | ✅ مادة قانونية | `website_total_price`، `website_total_price_words` | المادة العاشرة: المقابل المالي وآلية السداد |
