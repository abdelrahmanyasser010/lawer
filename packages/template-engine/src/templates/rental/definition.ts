...
ولا يترتب على هذا العقد انتقال ملكية العين أو إنشاء أو نقل أي حق عيني عليها لصالح الطرف الثاني، وإنما ينشئ له حقًا شخصيًا في الانتفاع بها طوال مدة العقد وفي حدود أحكامه والقانون.`;
  ...
  if (["residential_lease_source_article_12", "commercial_lease_source_article_13", "administrative_lease_source_article_13"].includes(key)) {
    body = `تاريخ تسليم العين المؤجرة المتفق عليه هو {{property_delivery_date}}. ويُعتد بهذا التاريخ في تحديد بدء الحيازة وآثار التسليم، ما لم يثبت اتفاق كتابي لاحق بين الطرفين على تاريخ آخر.
...
.6 عدم جواز اعتبار مبلغ التأمين أو شيكات الضمان وفاءً: لا يعفي وجود أي منهما المستأجر من سداد الأجرة وسائر الالتزامات المالية في مواعيدها.`;
  ...
  const variables = ["residential_lease_source_article_22", "commercial_lease_source_article_21", "administrative_lease_source_article_21"].includes(key)
